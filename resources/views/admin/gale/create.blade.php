...
<div class="flex items-center justify-center">
	...
	<form action="{{route('gale.store')}}" method="POST"  class="mt-16 py-8 bg-white px-32 shadow-lg rounded-lg font-sans">
		 {{ csrf_field() }}
	 <div class="border-b py-3 text-grey-darker mb-4 font-bold "> Create a Category for Gallery </div>
