...
<div class="mt-16">
	<a href="{{ route('users.create' )}}" class="bg-blue-dark hover:bg-blue px-4 text-white text-sm py-2 rounded-full ml-12 mr-2 no-underline" >Create User</a> 
	          ...
	          <tr class="border-b border-t text-grey-darker text-sm">
	            ...
	            <td class="py-4 pl-6">{{ Carbon\Carbon::parse($user->created_at)->toFormattedDateString()}}</td>
	                <td class="flex justify-end"> 
	                  <a href="{{ route('users.show', $user->id )}}" class="text-grey-dark pt-5 pr-2 pl-1" title="view"><i class="fa fa-eye " ></i></a>
	                   <a href="{{ route('users.edit', $user->id )}}" class="text-grey-dark pt-5 pr-2 pl-1"><i class="fa fa-pencil-square-o" title="edit"></i></a>
